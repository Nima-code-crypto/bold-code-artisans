    ...
    <section id="tech" className="section-padding relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
          {technologies.map((tech, i) => (
            <motion.div
              ...
              className="glass-card p-6 flex flex-col items-center gap-3 group cursor-default hover:border-primary/30 transition-all duration-300"
            >
              <div
        ...
        <motion.div
          ...
          className="mt-16 max-w-2xl mx-auto glass-card p-6 font-mono text-sm"
        >
